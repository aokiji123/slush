...
export const CommunityPostCard = ({
  ...
  const renderMedia = () => {
    const coverMedia =
      post.media.find((media) => media.isCover) ||
      (post.media.length > 0 ? post.media[0] : undefined)

    if (!coverMedia) return null

    if (coverMedia.type === 1) {
      // Video
      return (
        <div className="relative h-[240px] sm:h-[360px] md:h-[480px] rounded-[12px] md:rounded-[16px] overflow-hidden">
          <video
            src={coverMedia.file}
            controls
    ...
    return (
      <img
        src={coverMedia.file}
        alt="Post media"
        className="w-full h-[240px] sm:h-[360px] md:h-[480px] object-cover rounded-[12px] md:rounded-[16px]"
      />
    )
  }
        ...
        return (
          <div className="space-y-3 md:space-y-4">
            ...
            <div className="space-y-2 md:space-y-3">
              ...
              <p className="text-[14px] md:text-[16px] text-[#f1fdff] leading-[1.5]">
                {post.content}
              </p>
            </div>
          </div>
      ...
      case PostType.Guide:
        return (
          <div className="flex flex-col sm:flex-row gap-4 md:gap-5">
            {post.media.length > 0 && (
              <div className="flex-shrink-0 w-full sm:w-[200px] h-[240px] sm:h-full">
                <img
            ...
            <div className="flex-1 space-y-2">
              ...
              <p className="text-[14px] md:text-[16px] text-[#f1fdff] leading-[1.5] line-clamp-3">
                {post.content}
              </p>
            </div>
          </div>
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-2 flex-shrink-0">
          <button className="p-1.5 md:p-2 hover:bg-[rgba(55,195,255,0.12)] rounded-full transition-colors">
            <svg
