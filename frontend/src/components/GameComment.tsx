...
export const GameComment = memo(
  ({ review, onLikeToggle, isCurrentUserReview = false }: GameCommentProps) => {
    ...
    return (
      <div
        className={`w-full p-[20px] rounded-[20px] flex flex-col gap-[30px] lg:mb-[16px] relative ${
          isCurrentUserReview
