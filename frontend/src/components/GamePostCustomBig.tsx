...
export const GamePostCustomBig = ({ imageTop, name, date, title, text, like, comment, avatar, imageBottom, imageLeft, imageBotto2, _id, isNext = false, isHidUser }: CommentOneI) => {
  ...
  return <div className='bg-[var(--color-background-15)] rounded-[20px] comment-one-g'>
    ...
    <div className={`w-full flex flex-col pl-[24px] pr-[24px] pt-[${!isHidUser ? 16 : 1}px] pb-[16px]`}>
      {!isHidUser && <div className="w-full flex flex-row items-center justify-between">
