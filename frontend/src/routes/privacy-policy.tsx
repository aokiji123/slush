  ...
  return (
    <ErrorBoundary>
      <div className="relative bg-[var(--color-night-background)] min-h-screen">
        ...
        {/* Main content */}
        <div className="container mx-auto px-[228px] py-[64px]">
            ...
            <div className="flex flex-col gap-[48px]">
              ...
              <div className="flex flex-col gap-[24px] text-white max-w-none">
                ...
                <ul className="list-disc mb-0 pl-[1.5em]">
                  <li className="mb-2">
                    <span className="font-normal text-[20px] leading-[1.4] tracking-[-0.2px]">{t('privacyPolicy.section2_1_1')}</span>
                  </li>
                  <li className="mb-2">
                    <span className="font-normal text-[20px] leading-[1.4] tracking-[-0.2px]">{t('privacyPolicy.section2_1_2')}</span>
                  </li>
                  <li className="mb-2">
                    <span className="font-normal text-[20px] leading-[1.4] tracking-[-0.2px]">{t('privacyPolicy.section2_1_3')}</span>
                  </li>
                  <li className="mb-2">
                    <span className="font-normal text-[20px] leading-[1.4] tracking-[-0.2px]">{t('privacyPolicy.section2_1_4')}</span>
                  </li>
                  <li className="mb-2">
                    <span className="font-normal text-[20px] leading-[1.4] tracking-[-0.2px]">{t('privacyPolicy.section2_1_5')}</span>
                  </li>
                </ul>
                ...
                <ul className="list-disc mb-0 pl-[1.5em]">
                  <li className="mb-2">
                    <span className="font-normal text-[20px] leading-[1.4] tracking-[-0.2px]">{t('privacyPolicy.section3_1_1')}</span>
                  </li>
                  <li className="mb-2">
                    <span className="font-normal text-[20px] leading-[1.4] tracking-[-0.2px]">{t('privacyPolicy.section3_1_2')}</span>
                  </li>
                  <li className="mb-2">
                    <span className="font-normal text-[20px] leading-[1.4] tracking-[-0.2px]">{t('privacyPolicy.section3_1_3')}</span>
                  </li>
                </ul>
                ...
                <ul className="list-disc mb-0 pl-[1.5em]">
                  <li className="mb-2">
                    <span className="font-normal text-[20px] leading-[1.4] tracking-[-0.2px]">{t('privacyPolicy.section7_1_1')}</span>
                  </li>
                  <li className="mb-2">
                    <span className="font-normal text-[20px] leading-[1.4] tracking-[-0.2px]">{t('privacyPolicy.section7_1_2')}</span>
                  </li>
                  <li className="mb-2">
                    <span className="font-normal text-[20px] leading-[1.4] tracking-[-0.2px]">{t('privacyPolicy.section7_1_3')}</span>
                  </li>
                  <li className="mb-2">
                    <span className="font-normal text-[20px] leading-[1.4] tracking-[-0.2px]">{t('privacyPolicy.section7_1_4')}</span>
                  </li>
                  <li className="mb-2">
                    <span className="font-normal text-[20px] leading-[1.4] tracking-[-0.2px]">{t('privacyPolicy.section7_1_5')}</span>
                  </li>
                  <li className="mb-2">
                    <span className="font-normal text-[20px] leading-[1.4] tracking-[-0.2px]">{t('privacyPolicy.section7_1_6')}</span>
                  </li>
                </ul>
