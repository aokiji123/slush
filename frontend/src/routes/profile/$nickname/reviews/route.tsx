...
import { ProfileTabs, ProfileHeader, ProfileTabToolbar, ProfileReviewCard } from '@/components'
...
function ProfileReviewsPage() {
  ...
  const sortOptions = [
    ...
    { label: t('sorting.highestRated'), value: 'Rating:desc' },
    { label: t('sorting.lowestRated'), value: 'Rating:asc' },
            ...
            <div style={{ width: '1092px' }}>
              ...
              <div className="bg-[#004252] p-[20px] rounded-[20px] flex flex-col gap-[12px]">
                ...
                <ProfileTabToolbar
                  ...
                  searchPlaceholder={t('profile.searchPlaceholders.reviews')}
                  sortBy={sortBy}
