...
const getNotificationSettings = (t: any) => [
  {
    key: 'bigSale' as keyof NotificationsSettings,
    label: t('notifications.bigSale'),
  },
  {
    key: 'wishlistDiscount' as keyof NotificationsSettings,
    label: t('notifications.wishlistDiscount'),
  },
  {
    key: 'newProfileComment' as keyof NotificationsSettings,
    label: t('notifications.newProfileComment'),
  },
  {
    key: 'newFriendRequest' as keyof NotificationsSettings,
    label: t('notifications.newFriendRequest'),
  },
  {
    key: 'friendRequestAccepted' as keyof NotificationsSettings,
    label: t('notifications.friendRequestAccepted'),
  },
  {
    key: 'friendRequestDeclined' as keyof NotificationsSettings,
    label: t('notifications.friendRequestDeclined'),
  },
]
...
function RouteComponent() {
  ...
  return (
    <div className="w-full bg-[var(--color-background-15)] rounded-[20px] overflow-hidden text-white p-[24px] pb-[40px] flex flex-col gap-[64px]">
      <div className="w-full md:max-w-[500px] max-w-full flex flex-col gap-[16px]">
      ...
      <div className="w-full max-w-[650px]">
        ...
        <div className="flex gap-[16px] flex-col md:flex-row md:items-end md:justify-between">
