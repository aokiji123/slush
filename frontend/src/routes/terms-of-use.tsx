  ...
  return (
    <ErrorBoundary>
      <div className="relative bg-[var(--color-night-background)] min-h-screen overflow-x-hidden">
        ...
        {/* Main content */}
        <div className="container mx-auto px-4 sm:px-6 md:px-12 lg:px-24 xl:px-[120px] 2xl:px-[228px] py-[32px] sm:py-[48px] lg:py-[64px] relative">
          <div className="bg-[var(--color-background-15)] rounded-[20px] sm:rounded-[24px] lg:rounded-[30px] p-[24px] sm:p-[32px] md:p-[48px] lg:p-[64px] box-border">
            <div className="flex flex-col gap-[24px] sm:gap-[32px] lg:gap-[48px]">
              {/* Title */}
              <h1 className="text-white font-bold text-[24px] sm:text-[28px] lg:text-[32px] leading-[1.25] font-manrope mb-0">
                {t('termsOfUse.title')}
              </h1>
              ...
              <div className="flex flex-col text-white max-w-none">
                ...
                <p className="leading-[1.25] mb-0 text-[16px] sm:text-[20px] lg:text-[32px]">
                  &nbsp;
                </p>
                ...
                <p className="leading-[1.25] mb-0 text-[14px] sm:text-[16px] lg:text-[20px]">
                  &nbsp;
                </p>
