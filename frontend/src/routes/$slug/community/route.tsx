...
function RouteComponent() {
  ...
  const onHandlerSearchValue = (e: ChangeEvent<HTMLInputElement>) =>
      ...
      <div className="w-[25%] flex flex-col gap-[42px] min-w-[338px] mb-[256px]">
        ...
        <div className="w-full flex flex-col p-[20px] bg-[var(--color-background-16)] rounded-[20px]">
          <div className="flex items-center gap-[6px] relative">
            <p className="text-[var(--color-background-25)] text-[14px] cursor-pointer">
              Сортування:
            </p>
            <div className="search-select-g">
              <div className="flex items-center gap-[6px]">
                <p className="text-[var(--color-background)] text-[14px] cursor-pointer">
                  {postTypeSort.showText}
                </p>
          ...
          <input
            className="w-full input-search-community"
            placeholder={'Пошук: ' + postType}
            value={valueSearch}
            onChange={onHandlerSearchValue}
          />
