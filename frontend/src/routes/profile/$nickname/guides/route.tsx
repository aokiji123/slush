...
import { ProfileTabs, ProfileHeader, ProfileTabToolbar, ProfileGuideCard } from '@/components'
...
export const Route = createFileRoute('/profile/$nickname/guides')({
  component: ProfileGuidesPage,
})

function ProfileGuidesPage() {
            ...
            <div style={{ width: '1092px' }}>
              ...
              <div className="bg-[#004252] p-[20px] rounded-[20px] flex flex-col gap-[12px]">
                ...
                <ProfileTabToolbar
                  ...
                  searchPlaceholder={t('profile.searchPlaceholders.guides')}
                  sortBy={sortBy}
