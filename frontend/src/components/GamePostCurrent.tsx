    ...
    <div>
      <div className="w-full flex flex-row items-center justify-between">
        <div className="flex flex-row items-center gap-[12px] mb-[16px]">
          ...
          >
            ...
            <path
              id="Vector"
              d="M10.7 20C10.4 20 10.2 19.9 10 19.7L3.3 12.7C3.2 12.6 3.2 12.5 3.1 12.4C3.1 12.4 3.1 12.4 3.1 12.3C3 12.3 3 12.2 3 12C3 11.9 3 11.8 3.1 11.7C3.1 11.7 3.1 11.7 3.1 11.6C3.1 11.5 3.2 11.4 3.3 11.3L10 4.3C10.4 3.9 11 3.9 11.4 4.3C11.8 4.7 11.8 5.3 11.4 5.7L6.3 11L20 11C20.6 11 21 11.4 21 12C21 12.6 20.6 13 20 13L6.3 13L11.4 18.3C11.8 18.7 11.8 19.3 11.4 19.7C11.2 19.9 10.9 20 10.7 20Z"
      ...
      <div className="bg-[var(--color-background-15)] rounded-[20px] comment-one-g">
        ...
        <div className="w-full flex flex-col p-[24px] pt-[16px] pb-[16px]">
          {imageBottom && (
            <img src={imageBottom} className="w-full mt-[16px]" />
          )}
          ...
          {imageBotto2 && (
            <img
              src={imageBotto2}
              className="w-full mt-[12px] rounded-[16px]"
            />
          )}
        </div>
      </div>
