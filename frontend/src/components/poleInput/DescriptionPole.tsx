...
export const DescriptionPole = ({ classTitle = '', classInput = '', placeholder, title, value, onChange, classContainer = '', limitSymbol }: DescriptionPoleI) => {
  ...
  return <div className={'w-full flex flex-col gap-[8px] ' + classContainer}>
    ...
    <div className="w-full relative">
      <textarea className={'w-full style-pole-input style-pole-input-big-simple ' + classInput} placeholder={placeholder} value={value} onChange={onHandlerInput} />
    </div>
  </div>
}